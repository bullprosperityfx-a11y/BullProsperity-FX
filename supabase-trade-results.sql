...
-- Kompatibilitaet mit der bereits vorhandenen Admin-Tabelle: Dort ist id
-- ein bigint ohne Sequenz. API-Inserts benoetigen einen automatischen Wert.
do $$
begin
  if exists (
    select 1
    ...
    alter table public.trade_results
